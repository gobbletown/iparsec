...
/* package iparsec-0.1.0.0 */
#ifndef VERSION_iparsec
#define VERSION_iparsec "0.1.0.0"
#endif /* VERSION_iparsec */
#ifndef MIN_VERSION_iparsec
#define MIN_VERSION_iparsec(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_iparsec */
...
#define CURRENT_COMPONENT_ID "iparsec-0.1.0.0-inplace-iparsec"
